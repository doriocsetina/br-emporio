			...
			>
				...
				>
					<path
						...
						d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 100 6 3 3 0 000-6zm9-9H6.606m9.894 0l-1.2 6.4a1.125 1.125 0 01-1.107.9H8.25m0 0L6.75 5.25m1.5 9h9.75a1.125 1.125 0 001.107-.9l1.2-6.4H6.75"
					/>
				</svg>
									...
									<div class="min-w-0 flex-1">
										...
										<div class="text-sm text-gray-500">
											...
											<input
												...
												value={it.quantity}
												onchange={(e) =>
													setQuantity(it.id, Number((e.target as HTMLInputElement).value))}
											/>
										</div>
									</div>
